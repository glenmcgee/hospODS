...
for(jj in (1:num_iter)){
  ...
  results_SRS <- c(fit_ML(sample_SRS_10),
                   fit_ML(sample_SRS_20),
                   fit_ML(sample_SRS_30),
                   fit_ML(sample_SRS_50) )
  ...
  results_SRSpropto <- c(fit_ML(sample_SRSpropto_10),
                         fit_ML(sample_SRSpropto_20),
                         fit_ML(sample_SRSpropto_30),
                         fit_ML(sample_SRSpropto_50) )

  ####################################################################
  #                   SRS - at the margin ML                         #
  ####################################################################   
  
  results_SRSmargin <- c(fit_ML(sample_SRSmargin_10),
                         fit_ML(sample_SRSmargin_20),
                         fit_ML(sample_SRSmargin_30),
                         fit_ML(sample_SRSmargin_50) )
  
  ####################################################################
  #                   SRS - at the margin (SRR) ML                   #
  ####################################################################   
  
  results_SRSmarginSRR <- c(fit_ML(sample_SRSmarginSRR_10),
                         fit_ML(sample_SRSmarginSRR_20),
                         fit_ML(sample_SRSmarginSRR_30),
                         fit_ML(sample_SRSmarginSRR_50) )
  ...
  results_CSCCpropto <- c(fit_CSCC(sample_CSCCpropto_10),
                          fit_CSCC(sample_CSCCpropto_20),
                          fit_CSCC(sample_CSCCpropto_30),
                          fit_CSCC(sample_CSCCpropto_50) )
  ...
  results_CSCCmargin <- c(fit_CSCC(sample_CSCCmargin_10),
                          fit_CSCC(sample_CSCCmargin_20),
                          fit_CSCC(sample_CSCCmargin_30),
                          fit_CSCC(sample_CSCCmargin_50) )
  ...
  results_CSCCmarginSRR <- c(fit_CSCC(sample_CSCCmarginSRR_10),
                             fit_CSCC(sample_CSCCmarginSRR_20),
                             fit_CSCC(sample_CSCCmarginSRR_30),
                             fit_CSCC(sample_CSCCmarginSRR_50) )
  
  ####################################################################
  #                          SRS WEIGHTED                            #
  ####################################################################   
  
  results_SRS_WL <- c(fit_CSCC(sample_SRS_10,SRS=TRUE),
                   fit_CSCC(sample_SRS_20,SRS=TRUE),
                   fit_CSCC(sample_SRS_30,SRS=TRUE),
                   fit_CSCC(sample_SRS_50,SRS=TRUE) )
  ...
  results_SRSpropto_WL <- c(fit_CSCC(sample_SRSpropto_10,SRS=TRUE),
                         fit_CSCC(sample_SRSpropto_20,SRS=TRUE),
                         fit_CSCC(sample_SRSpropto_30,SRS=TRUE),
                         fit_CSCC(sample_SRSpropto_50,SRS=TRUE) )
  
  ####################################################################
  #                   SRS - at the margin WL                         #
  ####################################################################   
  
  results_SRSmargin_WL <- c(fit_CSCC(sample_SRSmargin_10,SRS=TRUE),
                         fit_CSCC(sample_SRSmargin_20,SRS=TRUE),
                         fit_CSCC(sample_SRSmargin_30,SRS=TRUE),
                         fit_CSCC(sample_SRSmargin_50,SRS=TRUE) )
  
  ####################################################################
  #                   SRS - at the margin (SRR) WL                  #
  ####################################################################   
  
  results_SRSmarginSRR_WL <- c(fit_CSCC(sample_SRSmarginSRR_10,SRS=TRUE),
                            fit_CSCC(sample_SRSmarginSRR_20,SRS=TRUE),
                            fit_CSCC(sample_SRSmarginSRR_30,SRS=TRUE),
                            fit_CSCC(sample_SRSmarginSRR_50,SRS=TRUE) )
  ...
  results_CSCCpropto_offset <- c(fit_CSCC(sample_CSCCpropto_10,offset_method=TRUE),
                                 fit_CSCC(sample_CSCCpropto_20,offset_method=TRUE),
                                 fit_CSCC(sample_CSCCpropto_30,offset_method=TRUE),
                                 fit_CSCC(sample_CSCCpropto_50,offset_method=TRUE) )
  ...
  results_CSCCmargin_offset <- c(fit_CSCC(sample_CSCCmargin_10,offset_method=TRUE),
                                 fit_CSCC(sample_CSCCmargin_20,offset_method=TRUE),
                                 fit_CSCC(sample_CSCCmargin_30,offset_method=TRUE),
                                 fit_CSCC(sample_CSCCmargin_50,offset_method=TRUE) )
  ...
  results_CSCCmarginSRR_offset <- c(fit_CSCC(sample_CSCCmarginSRR_10,offset_method=TRUE),
                                    fit_CSCC(sample_CSCCmarginSRR_20,offset_method=TRUE),
                                    fit_CSCC(sample_CSCCmarginSRR_30,offset_method=TRUE),
                                    fit_CSCC(sample_CSCCmarginSRR_50,offset_method=TRUE) )
  ...
  df <- rbind(df,c(jj,results_full,#results_naive, leaving out since it has different dimensions (missing xw.bin)
...
## returns results
write.table(x=df, file="sim2_results.txt", row.names=F, col.names=F, quote=F)
